  ...
  import {
    TextField, Button, Container, Typography, Box, MenuItem, Chip, Stack
  } from '@mui/material';
      ...
      <Container maxWidth="md">
        ...
        <Box sx={{ mt: 4 }}>
          ...
          <form onSubmit={handleSubmit(onSubmit)}>
            <TextField fullWidth label="Job Title" {...register('title')} margin="normal" required />
...
<input type="hidden" {...register('description', { required: true })} />         
   <TextField fullWidth label="Skills (comma separated)" {...register('skills')} margin="normal" helperText="e.g. React, Node.js, MongoDB" />
            ...
            <Box sx={{ mt: 3 }}>
              <Button type="submit" variant="contained" size="large">Create Job Posting</Button>
            </Box>
          </form>
        </Box>
      </Container>
